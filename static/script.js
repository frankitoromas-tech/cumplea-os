...
/* ══════════════════════════════════════════════════════════════
   21 · CONTROL DE MÚSICA
   ──────────────────────────────────────────────────────────────
   El widget flotante (volumen +/−, pausa/play) y el handling de
   autoplay viven ahora en static/js/control-musica.js — un módulo
   reutilizado también por las subpáginas (carta, universo, timeline,
   aurora) para que cada una toque su propia canción y respete el
   volumen/pausa que el usuario haya configurado.
   ══════════════════════════════════════════════════════════════ */